...
function Sidebar() {
    ...
    // Supposons que le role_id est stocké dans le localStorageAdd commentMore actions
                ...
                {canManage && (
                    <li>
                        <Link to={`/departments`}>
                            ...
                            {isOpen && <span className="project-title">Départements</span>}
                        </Link>
                    </li>
                )}
                {canManage && (
                    <li>
                        <Link to={`/teams`}>
                            ...
                            {isOpen && <span className="project-title">Equipes</span>}
                        </Link>
                    </li>
                )}
